...
In order to ensure that our customer's point of view was at the forefront of our design, we developed three [proto-personas](https://uxmag.com/articles/using-proto-personas-for-executive-alignment), each of which represent a different user-type. These personas informed our customer-centric point of view as to the design and implementation of our product, and can be seen below. The inclusion of the proto-personas ensured that our system had a customer focused designed at all stages, which will be explored in the implementation of our system as well. Each of these user types will be explained in detail, as well as example user stories that we kept at the centre of our design process. These user stories that influenced the [requirements of each subsystem](#user-requirements-for-each-subsystem) will be explained in detail later on in our report. 
