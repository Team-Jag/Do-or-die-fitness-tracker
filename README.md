...
You will learn more about Mario in our [System Design section](https://github.com/Team-Jag/Do-or-die-fitness-tracker/blob/develop/Portfolio/SystemDesign.md#end-user). Throughout our report we will use Mario as our focus use case, while also highlighting how other user groups can use our system, we will guide you through the process of making Do or Die. 
